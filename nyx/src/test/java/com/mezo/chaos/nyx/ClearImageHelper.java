...
public class ClearImageHelper {
    ...
    public static void main(String[] args) throws IOException{
        ...
        File testDataDir = new File("/Users/mezo/Downloads/WechatIMG23.png");//去噪
        BufferedImage bufferedImage = ImageIO.read(testDataDir);
        BufferedImage denoise = denoise(bufferedImage);
        String destDir ="/Users/mezo/Downloads/temp/";
        ImageIO.write(denoise,"jpg",new File(destDir+"123.jpg"));
